...
impl Context {
    pub fn new(fb: Box<dyn Framebuffer>, //rtc: Option<Rtc>, library: Library,
               ...
               //frontlight: Box<dyn Frontlight>, lightsensor: Box<dyn LightSensor>
    ) -> Context {
        let dims = fb.dims();
        ...
        Context { fb, /*rtc,*/ display: Display { dims, rotation }, //library,
            settings, fonts, //dictionaries: BTreeMap::new(),
